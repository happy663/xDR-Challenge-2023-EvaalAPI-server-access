...
from sub import estimate, google_drive, gt
...
def single_run(
    ...
    google_drive.upload_to_drive(
        log_file_name[:-3] + ".png",
        "./output/image/" + log_file_name[:-3] + ".png",
        "image/jpeg",
        created_folder_id,
    )
    ...
    if not os.path.exists("./output/image/" + gt_filepath[6:-4] + ".png"):
        ...
        google_drive.upload_to_drive(
            gt_filepath[6:-4] + ".png",
            "./output/image/" + gt_filepath[6:-4] + ".png",
            "image/jpeg",
            created_folder_id,
        )
    else:
...
if __name__ == "__main__":
    ...
    single_run("../trials/", "8_1_51.txt", "../gt/8_1_gt.csv", created_folder_id)
